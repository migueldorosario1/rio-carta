---
title: "Crime organizado amplia controle no RJ e já opera em mais de 100 pontos da Região Metropolitana"
description: "O avanço da exploração ilegal de serviços de internet se tornou um dos principais focos das investigações sobre o financiamento do crime organizado no Rio de Janeiro. Informações d"
...
*Fonte: [Diário do Rio](https://diariodorio.com/crime-organizado-amplia-controle-no-rj-e-ja-opera-em-mais-de-100-pontos-da-regiao-metropolitana/).*
