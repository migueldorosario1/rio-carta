...
description: "A Operação Sem Refino não é apenas um caso de corrupção — é a exposição sistêmica de como o Estado fluminense foi instrumentalizado por redes privadas de acumulação, revelando a falência de um modelo que trocou soberania por subcontratação e cidadania por caixa de sapato."
